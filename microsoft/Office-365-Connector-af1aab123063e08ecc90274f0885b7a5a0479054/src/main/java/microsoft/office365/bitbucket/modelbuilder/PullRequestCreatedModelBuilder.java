 ...
 * @author srhebbar
 */
public class PullRequestCreatedModelBuilder extends ModelBuilder {

    public PullRequestCreatedModelBuilder(PullRequestEvent event) {
        super(event);
    }

    public PullRequestCreatedModelBuilder(PullRequestEvent pullRequest, NavBuilder navBuilder) {
    ...
    public Card Build() {
        ...
        String subTitle = "has created pull request #" + pullRequest.getId() 

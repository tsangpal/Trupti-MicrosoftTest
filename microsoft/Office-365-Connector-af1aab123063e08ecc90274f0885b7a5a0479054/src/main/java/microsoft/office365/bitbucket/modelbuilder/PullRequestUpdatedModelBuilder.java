 ...
 * @author srhebbar
 */
public class PullRequestUpdatedModelBuilder extends ModelBuilder {

    public PullRequestUpdatedModelBuilder(PullRequestEvent pullRequest) {
        super(pullRequest);
    }

    public PullRequestUpdatedModelBuilder(PullRequestEvent pullRequest, NavBuilder navBuilder) {
    ...
    public Card Build() {
        ...
        String subTitle = "has updated pull request #" + pullRequest.getId() 

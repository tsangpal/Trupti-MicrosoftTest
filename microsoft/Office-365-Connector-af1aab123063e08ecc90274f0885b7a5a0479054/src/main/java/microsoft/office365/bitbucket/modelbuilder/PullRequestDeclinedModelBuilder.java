 ...
 * @author srhebbar
 */
public class PullRequestDeclinedModelBuilder extends ModelBuilder {

    public PullRequestDeclinedModelBuilder(PullRequestEvent pullRequest) {
        super(pullRequest);
    }

    public PullRequestDeclinedModelBuilder(PullRequestEvent pullRequest, NavBuilder navBuilder) {
    ...
    public Card Build() {
        ...
        String subTitle = "has declined pull request #" + pullRequest.getId() 
